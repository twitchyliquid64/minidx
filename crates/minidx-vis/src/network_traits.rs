...
impl<E: Dtype> LayerMarker for minidx_core::layers::ScalarScale<E> {}
...
impl<E: Float + minidx_core::matmul::MatMulImpl, const I: usize> LayerMarker
    for minidx_core::layers::RMSDiv<E, I>
{
}
